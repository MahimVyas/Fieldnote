...
function renderProject(project) {
  ...
  if (filter) filter.addEventListener('change', e => renderEvidenceList(e.target.value === 'all' ? currentEvidence : currentEvidence.filter(i => i.source_type === e.target.value)));
