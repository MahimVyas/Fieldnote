...
function renderProject(project) {
  ...
  document.querySelector('.results-head .eyebrow').innerHTML = `<i></i> EVIDENCE BRIEF${project.brief.grade ? ` <span class="grade g${project.brief.grade.tier}">${escapeHtml(project.brief.grade.label)} · ${project.brief.grade.score}</span>` : ''}`;
