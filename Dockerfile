FROM node:25-alpine
WORKDIR /app
COPY package.json server.js agents.js index.html script.js style.css favicon.svg icon-192.png icon-512.png maskable-512.png manifest.webmanifest sw.js LICENSE README.md ./
